...
export class MenuScene extends Scene {
  ...
  create(): void {
    ...
    // Title
    this.add.text(width / 2, height * 0.2, 'SETBACK', {
      fontSize: '64px',
      color: '#ffffff',
      fontStyle: 'bold',
      stroke: '#000000',
    ...
    // Start button
    const startButton = this.add.text(width / 2, height * 0.5, 'START GAME', {
      fontSize: '32px',
      color: '#ffffff',
    ...
    // Instructions button
    const instructionsButton = this.add.text(width / 2, height * 0.6, 'INSTRUCTIONS', {
      fontSize: '24px',
      color: '#ffffff',
...
First partnership to 21 points wins!
    ...
    const instructionsBox = this.add.text(width / 2, height / 2, instructionsText, {
      fontSize: '18px',
      color: '#ffffff',
